...
export class SidebarComponent implements OnInit, AfterViewInit {
  ...
  items: SidebarItem[] = [
    ...
    // Users
    {
      ...
      childrens: [
        {
          label: 'All Limited Partners',
          routerLink: this.navigation.getRouterLink('users', 'list')
        },
        {
          label: 'Limited Partners Fund1',
          routerLink: this.navigation.getRouterLink('users', 'list', 'role', 'LPFund1')
        },
        {
          label: 'Limited Partners Fund1A',
          routerLink: this.navigation.getRouterLink('users', 'list', 'role', 'LPFund1A')
        },
        {
          label: 'Add',
